<template>
  <div class="flex flex-col min-h-screen bg-brand-bg">
    ...
    <main class="flex-1 flex items-center justify-center p-4 md:p-8">
      ...
      <div class="w-full max-w-lg bg-white rounded-xl border border-gray-200 py-6 p-5 md:p-6 md:py-8 my-14">
        
        <div class="mb-8">
          <h1 class="text-2xl font-bold text-brand-dark mb-2">Admin Portal</h1>
          <p class="text-sm text-gray-500">Log in to manage suppliers and listings</p>
        </div>
    ...
    <footer class="bg-brand-tealDark text-white py-8 px-6 mt-auto shrink-0">
      <div class="max-w-5xl mx-auto text-center">
        <p class="text-xs opacity-60">© 2026 wayoya - Admin Portal</p>
      </div>
    </footer>
